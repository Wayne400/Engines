...
def main():
 ...
 #           if not this_plate == last_plate:  # dont print multiple ads of same car
                if pick_make == "ra":
                    print_rambler(search_index=ad_index, sql_data=ads_table, total_no_of_ads=no_of_ads, year_estimate=nsw_dummy_object[0])
                elif pick_make == "re":
                    print_renault_nsw(search_index=ad_index, sql_data=ads_table, total_no_of_ads=no_of_ads,year_estimate=nsw_dummy_object[0])
                elif pick_make == "fo":
